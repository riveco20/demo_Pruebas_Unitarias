...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long result2 = calculator.subtraction(number1,number2);
        long result3 = calculator.multiplication(number1,number2);
        Float result4= calculator.division(number1,number2);
